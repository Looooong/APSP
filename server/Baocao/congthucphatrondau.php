...
<div class="haivl">
    ...
    <div class="title_saigon">
    	<h2 style="text-align:center">CÔNG THỨC PHA TRỘN DẦU</h2>
        <h4 style="text-align:center">BLENDING NOTE (BLN)</h4>
    </div>
    <div class="content">
...
?>
        ...
        <table class="table" cellpadding="0" cellspacing="0" border="1">
          		...
          		<tr>
                	<th colspan="7"><h4>CÔNG THỨC/FORMULATION</h4></th>
                </tr>
            	<tr>
				...
				?>
                <tr>
                	<th colspan="7"><h4>DẦU GỐC/BASE OIL</h4></th>
                </tr>
                <?php
                	foreach ($materials as $data) {
						if ($data['baseOil']) {
                ...
                <tr>
                	<th colspan="7"><h4>PHỤ GIA/ADDITIVE</h4></th>
                </tr>
                <?php
                	foreach ($materials as $data) {
						if (!$data['baseOil']) {
                ...
                <tr>
                	<td colspan="7"> <p style="float:left"><strong>Ghi Chú /Remarks:</strong></p>
</td>
                </tr>
          </table>
          <div class="footer">
              <div style="border-right:1px solid #000;"class="footer_1 fl">
                <p>Người Lập Công Thức</p><p style="font-size:10px">Formulation by</p>
                <p style="margin-top:150px"><strong>Dương Nữ Kiều Trang</strong></p>
              </div>
               <div style="border-right:1px solid #000" class="footer_1 fl">
                <p>TP.Nghiên Cứu & P.Triển KCS</p><p style="font-size:10px">R&D and QC Manager</p>
               	<p style="margin-top:150px"><strong>Nguyễn Nam Ninh</strong></p>

              </div>
               <div class="footer_1 fl">
                <p>Giám Đốc Nhà Máy</p><p style="font-size:10px">Plan Director</p>
                <p style="margin-top:150px"> <p><strong>Phùng Lễ Minh</strong></p>
</p>
