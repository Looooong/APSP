...
.bh_0 { color:#F00}
 ...
 if (isset($_REQUEST['database'])) {		
	...
	$_SESSION['database'] = $database;
  	$query = "Select adID,hoTen ,luongCB,thamgiabh,tenDangVI 
	From ".$database.".dbo.hosonv,".$database.".dbo.danghd 
	Where ".$database.".dbo.hosonv.dangID=".$database.".dbo.danghd.dangID and ".$database.".dbo.hosonv.nhomID=1";
	$db->QuerySql($query);
