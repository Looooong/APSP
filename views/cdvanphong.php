...
.cd_0 { color:#F00}
 ...
 <?php
  	$query = "select adID, tenCVVi,hinhanh,namSinh,dienThoai, hoTen,noiLamViec,thamgiacongdoan,ngaythamgiaCD,tenDangVI,luongCB from congty,hosonv,danghd where hosonv.cvID=congty.cvID and hosonv.dangID=danghd.dangID and nhomID=2";
	$db->QuerySql($query);
