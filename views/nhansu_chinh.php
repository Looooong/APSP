            ...
            <div id="steps">
                <div class="step">
                    <div class="block-header">
                        ...
                        <div class="clear"></div>
                        <div class="_50">
                            <p><label class="line_height_1"><?=$lang->get("hoTen")?></label><input name="hoTen" class="required fr" type="text" value="<?=$result['hoTen'] ?>" /></p>
                        </div>
                        <div class="_50">
                            <p><label class="line_height_1"><?=$lang->get("maNV")?></label><input name="maNV" class="required fr" type="text" value="<?= $result['maNV']?>" /></p>
                        </div>
                        <div class="_50">
                        ...
                        <div class="_50">
                            <p><label class="line_height_1" for="datepicker"><?=$lang->get("namSinh")?></label><input name="namSinh" class="required fr" type="text" value="" /></p>
                        </div>
                        <div class="_50">
                 	...
                 	<div class="block-header">
                        ...
                        <div class="_50">
                            <fieldset>
                                ...
                                <div class="_100">
                                  <p class="line_height"><label for="datepicker"><?=$lang->get("ngayCap")?></label><input  name="ngayCap" class="fr" style="width:220px" type="text" value="" /></p>
                                </div>
                                <div class="_100">
                       ...
                       <div class="_50">
                        	  <fieldset>
                                ...
                                <div class="_100">            
                                    <p><label class="line_height" for="datepicker"><?=$lang->get("ngayGiaNhap")?></label><input name="ngayGiaNhap" style="width:220px" class="fr" type="text" value="" /></p>
                                </div>                
                                <div class="_100">
				...
				<div class="step">
                    ...
                    <div class="_100">
                        <fieldset>
                            ...
                            <div class="_30">
                                <p class="line_height"><label for="datepicker"><?=$lang->get("ngayCapBH")?></label><input name="ngayCapBH" class="fr" style="width:120px"  type="text" value="" /></p>
                            </div>
                            <div class="_30">
                            ...
                            <div class="_30">
                                <p class="line_height"><label for="datepicker"><?=$lang->get("soBHYT")?></label><input  type="text" class="fr" style="width:120px" value="" name="soBHYT"/></p>
                            </div>
                            <div class="_30">
                    ...
                    <div class="_100">
                        <fieldset>	
                           <legend><?=$lang->get("congViec")?></legend>
                            <div class="_30">
                                <p class="line_height_1"><label for="datepicker"><?=$lang->get("ngayThuviec")?></label><input name="ngayThuviec" style="width:120px" class="fr" type="text" value=""/></p>
                            </div>
                            <div class="_30">
                            ...
                            <div class="_30">
                                <p class="line_height_1"><label for="datepicker"><?=$lang->get("ngayKetThuc")?></label><input name="ngayKetThuc" class="fr" style="width:120px" type="text" value="" /></p>
                            </div>
                            <hr style="clear:both" />
                            <div class="_30">
                                <p class="line_height_1"><label for="datepicker"><?=$lang->get("ngayBatDau")?></label><input name="ngayBatDau"style="width:120px" class="fr" type="text" value="" /></p>
                            </div>
                            <div class="_30">
                            ...
                            <div class="_30">
                                <p class="line_height"><label for="datepicker"><?=$lang->get("ngayThoiViec")?></label><input name="ngayThoiViec" class="fr" style="width:120px"  type="text" value="" /></p>
                            </div>
                            <div class="_30">
                            ...
                            <div class="_30">
                                <p class="line_height"><label for="datepicker"><?=$lang->get("ngayQuyetDinh")?></label><input name="ngayQuyetDinh" class="fr" style="width:120px"  type="text" value="" /></p>
                            </div>
                        </fieldset>
                     </div>
                </div>
                <div class="step">
                   ...
                   <div class="_100">
                            ...
                            <div class="_30">            
                                <p><label class="line_height" for="datepicker"><?=$lang->get("namSinhVC")?></label><input name="namSinhVC" class="fr" type="text" value="" /></p>
                            </div>	
                            <div class="_30">
