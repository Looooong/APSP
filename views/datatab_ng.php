...
$db->querySql($query);
    ...
    <div class="block-actions">
            <ul class="actions-left">
					<li><a class="button thickbox" id="reset-validate-form" href="table_ng.php?height=550&width=1000"><?=$lang->get('them')?></a></li>
					...
					<li><a class ="button" href = "exceldatatab1.php" target = "_blank"><?=$lang->get('xuat')?></a></li>
