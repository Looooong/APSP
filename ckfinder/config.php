...
function CheckAuthentication()
{
	...
	//return false;
	return isset($_SESSION['kt_login_id']); //kiểm tra login mới cho post
}
...
*/
$baseUrl = 'http://www.chandat.net/hinh/';
...
ATTENTION: The trailing slash is required.
*/
//$baseDir = "D:/SOFTWARES/INSTALL/AppServ/www/PHP04/upload/"; 
$baseDir = "/home/nhchatpx/public_html/hinh/";
/* để biết địa chỉ của website mình trên host, tạo trang test.php chứa mã <? echo $_SERVER['DOCUMENT_ROOT'];?>*/
