...
<body>    <div id="txthint">
	...
	<div style="width:980px; margin:0 auto; font-size:18px;">
        ...
        <div class="content_hd">
        	<h1 style="text-align:center">LỆNH GIAO HÀNG</h1>
            <div style="float:right">
                <p>Tờ Trình Số: DN LT 1310-105</p>
                <p>Ngày: 18/10/2013</p>
			</div>
            ...
            <div style=" overflow:hidden">
                ...
                <div style="float:left">
                	<p>Ban Giám Đốc Công Ty xét duyệt bán dầu nhờn cho</p>
                    <h3>Cty TNHH LIÊN thẮNG</h3>
                </div><!--info_nd-->
            </div><!--content_info-->
			<p>Với số lượng hàng hóa như sau</p>
        	<div class="table_hd">
            	<table width="980" border="1" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="27" scope="col">Stt</td>
                    <td width="411" scope="col">Tên Hàng</td>
                    <td width="207" scope="col">Mô Tả Kỹ tduật</td>
                    <td width="97" scope="col">Đvt</td>
                    <td width="110" scope="col">Số Lượng</td>
                    <td width="114" scope="col">Ghi Chú</td>
                  </tr>
                  <tr>
                    <td  style="padding:5px; text-align:center">1</td>
                    <td  style="padding:5px; text-align:center">Dầu nhờn SP Hydraulic VG 68_200L</td>
                  ...
                  <tr>
                    ...
                    <td  style="padding:5px; text-align:center">Dầu nhờn AP Hydraulic VG 68_290L</td>
                    <td  style="padding:5px; text-align:center">&nbsp;</td>
                    <td  style="padding:5px; text-align:center">Phuy</td>
                    <td  style="padding:5px; text-align:center">2</td>
                    <td  style="padding:5px; text-align:center">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td  style="padding:5px; text-align:center">Dầu nhờn SP Hydraulic VG 99_200L</td>
                    <td  style="padding:5px; text-align:center">&nbsp;</td>
				...
				<h3 style="margin:10px 0">KHUYẾN MÃI</h3>
            	<table width="980" border="1" cellspacing="0" cellpadding="0">
                  <tr>
                    <td scope="col">Stt</td>
                    <td scope="col">Tên Hàng</td>
                    <td scope="col">Mô Tả Kỹ tduật</td>
                    <td scope="col">Đvt</td>
                  ...
                  <tr>
                    <td  style="padding:5px; text-align:center">1</td>
                    <td  style="padding:5px; text-align:center">Dầu nhờn SP Hydraulic4T ag 68_200L</td>
                    <td  style="padding:5px; text-align:center">&nbsp;</td>
                    <td  style="padding:5px; text-align:center">Chai</td>
                    <td  style="padding:5px; text-align:center">2</td>
                    <td  style="padding:5px; text-align:center">&nbsp;</td>
            ...
            <div style="width:490px; margin-top:5px; float:left">
            	<span style="font-weight:bold; margin-right:125px">* Người Nhận:</span><span>Đỗ Đăng Quang</span>
                <div style=" clear:both"></div>
                <span style="font-weight:bold; margin-right:125px;">* Số CMND:</span><span>022.928.209</span>
            </div>
             <div style="margin-top:5px;">
            	<span style="float:left">* Người Phụ Trách:</span><p style="text-align:center">Lê Cao Tuệ</p>
            </div>
